...
| `user.deleteSelf`                   | Protected | Mutation | `{ password, confirm: 'DELETE' }` — deletes the caller's account, own recipes and all cascading data; clears the session; the last admin is refused                                                                                                                                                                                                                                                                                                                                                                              |
