...
| `tracker.getDay`                    | Protected | Query    | `{ date: YYYY-MM-DD }` — planned meals + the day's log (incl. custom entries) + resolved targets; planned meals carry `portion?` (P1-1, macros stay per serving)                                                                                                                                                                                                                                                  |
