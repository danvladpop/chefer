...
| `dashboard.summary`                 | Protected | Query    | `{ localDate?: YYYY-MM-DD, localHour?: 0–23 }` (optional) — the client's day and hour decide "today" and the next meal; server time if omitted                                                                                                                                                                                                                                                                    |
