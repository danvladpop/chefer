...
// Was the /pantry page; now the Shop tab's second segment (/pantry redirects
...
export function PantryPanel() {
  ...
  return (
    <div>
      ...
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        ...
        {enabled && items.length > 0 && !checkOpen && (
          <button
            ...
            className="flex min-h-11 shrink-0 items-center gap-1.5 rounded-xl border border-neutral-200 px-3 text-xs font-medium text-neutral-600 transition hover:bg-neutral-50"
          >
      ...
      <PantryCheckBanner
        manualOpen={checkOpen}
        onManualClose={() => setCheckOpen(false)}
        className="mb-4"
      />
