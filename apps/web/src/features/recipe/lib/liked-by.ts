...
// The selection is stored as one structured line INSIDE MealRating.notes
// ("Liked by: Maria, Tom"), so it survives round-trips without a schema
// change and stays out of the P1-1 signal reader's way (it only uses stars).
