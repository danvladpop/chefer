...
module.exports = {
  ...
  // Expo ecosystem to be transformed from there too.
  transformIgnorePatterns: [
    'node_modules/(?!(?:\\.pnpm/)?((jest-)?react-native|@react-native(-community)?|expo(nent)?|@expo(nent)?/.*|@expo-google-fonts/.*|react-navigation|@react-navigation/.*|@sentry/react-native|native-base|react-native-svg|react-native-css-interop|nativewind|superjson|copy-anything|is-what|@chefer/.*))',
  ],
};
