...
| prod follow-ups | 🟡 2026-08-22 — issues found while testing live production are tracked in [`docs/prod-followups.md`](./docs/prod-followups.md) — currently: `/meal-plan` stuck on the loading fallback (React #418 hydration mismatch, Sentry has the event; high priority) + one low-confidence chat-send observation. Fix these in a follow-up session before beta users.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| A11 (backups)   | ✅ 2026-08-22 — nightly `pg_dump` cron installed on the VM (03:00 UTC, keeps 14); restore rehearsed: fresh dump restored into scratch DB `chefer_restore_test`, all row counts matched live (users 6, meal_plans 18, recipes 298), ~1 s restore. RPO 24 h / RTO ~5 min (VM alive) or ~1–2 h (VM lost) documented in `infrastructure.md` §12, incl. the known gap: dumps sit on the same VM disk — add an off-VM copy before real users                                                                                                                                                                                                                                                                                                                                                                                                      |
| everything else | ⬜                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
