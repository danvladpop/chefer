...
| A2   | **P0-2**         | Delete `/user` PII leak, close public read, guard `/ingredients`                                                                                                                                           |
| A3   | **P0-1**         | Fix dashboard next-meal logic                                                                                                                                                                              |
| A4   | **P0-3**         | CI on `master`, deploys gated on green                                                                                                                                                                     |
| A5   | **P0-4**         | Rate limiting + helmet + per-user AI quotas (the quota tiers are paywall surface)                                                                                                                          |
| A6   | **P0-5**         | Unify calorie target (premium's core promise must be _consistent_)                                                                                                                                         |
| A7   | **P0-6**         | Password reset                                                                                                                                                                                             |
