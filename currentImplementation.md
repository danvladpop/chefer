...
**Last updated:** T-025 · Recipes Browse Page & Favourites
**Phase:** 3 — Power Features (T-021–T-025 complete)
...
## Known Limitations (Phase 3 partially complete — T-021/T-022/T-023/T-025 done)

- No "forgot password" flow (out of scope for MVP)
- **Meal Plan History** (`/history`) — T-024 not yet built; page shows "Coming soon"
- **Meal Ratings** — T-026 not yet built
